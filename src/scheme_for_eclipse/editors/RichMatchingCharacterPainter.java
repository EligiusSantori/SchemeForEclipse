...
public class RichMatchingCharacterPainter implements IPainter, PaintListener {
	 ...
	 */
	public RichMatchingCharacterPainter(ISourceViewer sourceViewer, ICharacterPairMatcher matcher, StyleManager style) {
	...
	private void draw(GC gc, int offset, int length)
	{
		if (gc != null)
		{
			...
			TextAttribute attr = styleManager.BRACKET_CURRENT;
